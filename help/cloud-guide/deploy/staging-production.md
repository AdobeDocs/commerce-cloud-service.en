...
>[!TIP]
>
>Adobe recommends creating a [snapshot](../storage/snapshots.md) of the environment before deployments. Also, you can enable [Track deployments with New Relic](../monitor/track-deployments.md) to monitor deployment events and help you analyze performance between deployments.
