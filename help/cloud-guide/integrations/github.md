...
| ----------------------- | --------- | --------------------------------- |
| `--base-url`            | Yes       | The base URL of the server installation, which may be `https://github.com/` or a custom. NOTE: If the repository is hosted with public Github, you should omit this flag. |
