...
-  All existing data for the service is removed. Adobe strongly recommends that you create a [snapshot your environment](https://devdocs.magento.com/cloud/project/project-webint-snap.html) before you change the name of an existing service.
