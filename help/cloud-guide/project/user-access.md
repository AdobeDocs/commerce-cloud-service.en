...
You can use the [Project Web Interface](../../get-started/cloud-pwi.md) to add permissions and use the _Edit_ feature to modify permissions for an existing user.
